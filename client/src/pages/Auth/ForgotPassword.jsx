    ...
    return (
        <div className=" h-screen pb-10 pt-20 flex mx-auto">
          ...
          <div className="rounded-[20px] max-w-[400px] w-full slideDown pt-5 transition-opacity duration-300 ease-in shadow-2xl h-fit bg-white/30 backdrop-blur-xs mx-auto">
            ...
            <svg className='mx-auto mt-5' stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="50px" width="50px" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="text-xs mt-2 text-center">Enter your email to reset your password</p>
