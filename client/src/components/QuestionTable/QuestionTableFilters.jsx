...
const QuestionTableFilters = ({showFilters, setShowFilters, questionGroups, sections}) => {
  ...
  const filterOptions = {
    type: [
      ...
      { value: 'T', label: 'True/False' }
    ],
    quarter: sections.map(section => ({
      value: section.section_name,
      label: section.section_name
    })),
    group: questionGroups.map(group => ({
      value: group.title,
      label: group.title
    })),
    activeStatus: [
...
export default QuestionTableFilters;